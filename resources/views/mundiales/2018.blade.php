...
@section('content')
    ...
    <div class="container py-4">
        ...
        <div class="text-center mb-5">
            <img src="{{ asset($mundial->logo_url ?? 'img/2018/logo.jpg') }}" alt="Logo Mundial 2018" class="img-fluid rounded shadow" style="max-height: 200px;">
            <p class="text-muted mt-2">Logo oficial de la Copa Mundial de la FIFA 2018</p>
        </div>
